...
let projects = [];
const projectInfo1 = new Project('Awesome Books App', ' This is a book project I built to store and list books with just HTML CSS and Javascript. No frameworks Used.', 'img/awesomebooks.png', ['Frontend', 'Backend Dev', '2022'], ['HTML', 'CSS', 'Javascript'], 'https://mudasiri.github.io/awesome-books-es6/', 'https://github.com/mudasiri/awesome-books-es6');
